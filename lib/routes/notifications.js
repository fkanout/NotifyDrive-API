...
const gpsToAddress = require('../services/gpsToAddress');
...
module.exports = (router) => {
  router.post(
    ...
    async (ctx, next) => {
      ...
      const address = await gpsToAddress(ctx.request.body.lat, ctx.request.body.log);
      // ************

      const sentNotifications = await NotificationsHistory.create({
